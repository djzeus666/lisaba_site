...
В админке: **Уведомления о заявках** — все настройки в одном месте:

1. Telegram: токен бота (@BotFather), Chat ID, включение канала.
2. Email: SMTP хост/порт/логин/пароль, From, список получателей.
